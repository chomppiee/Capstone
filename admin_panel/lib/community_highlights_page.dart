...
class _CommunityHighlightsPageState extends State<CommunityHighlightsPage> {
  ...
  Future<void> _deleteHighlight(String docId, String? imageUrl) async {
    try {
      await FirebaseFirestore.instance.collection('community_highlights').doc(docId).delete();
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final double available = (constraints.maxWidth - (outerPadding * 2)).clamp(0, double.infinity);
          final double cardWidth = wide ? ((available - spacing) / 2).floorToDouble() : available;
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text("Add Highlight", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700)),
                        ...
                        if (_selectedDateTime != null) ...[
                          const SizedBox(height: 8),
                          Text("Selected: ${_fmtDateTime(_selectedDateTime!)}",
                        ...
                        SwitchListTile(
                          ...
                          subtitle: (_selectedDateTime != null && _isPastDateTime(_selectedDateTime!))
                              ? const Text("Locked: date/time is already past",
                          ...
                          onChanged: (val) {
                            if (_selectedDateTime != null &&
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text("Cannot enable participation for a past date/time."),
                                ),
                              );
                              return;
                            }
                ...
                const Text("Highlights", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700)),
                const SizedBox(height: 8),
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: const [
                              ...
                              SizedBox(width: 12),
                              Expanded(child: Text("No highlights uploaded yet. Create the first one above.")),
                            ],
                          ),
                        ),
                      );
                          ...
                          for (final doc in docs)
                            SizedBox(
                              ...
                              child: _HighlightCard(
                                ...
                                isPast: (() {
                                  final dtTs = (doc['date_time'] as Timestamp?);
                                  final dt = dtTs?.toDate();
                                  return dt == null ? false : _isPastDateTime(dt);
                                })(),
                                onEdit: () => _editHighlight(doc),
                                onDelete: (imageUrl) => _deleteHighlight(doc.id, imageUrl),
                              ),
                            ),
                        ],
                      );
                ...
                // ----- History (themed) -----
                const Text("History", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700)),
                const SizedBox(height: 8),
                StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      .collection('community_highlights_history')
                  ...
                  builder: (context, historySnapshot) {
                    ...
                    return ListView.separated(
                      ...
                      itemBuilder: (context, idx) {
                        ...
                        final dt = (data['date_time'] as Timestamp?)?.toDate();
                        return Card(
                          child: ListTile(
